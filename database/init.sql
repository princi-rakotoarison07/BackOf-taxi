...
CREATE TABLE disponibilite_vehicule (
    ...
    CONSTRAINT fk_disponibilite_vehicule FOREIGN KEY (id_vehicule) REFERENCES vehicule(id_vehicule) ON UPDATE CASCADE ON DELETE CASCADE
);
...
CREATE TABLE vehicule_nombre_trajets (
    ...
    CONSTRAINT fk_nombre_trajets_vehicule FOREIGN KEY (id_vehicule) REFERENCES vehicule(id_vehicule) ON UPDATE CASCADE ON DELETE CASCADE
);
